...
var Shapes = (function() {
	...
	var Shape = (function (){
		...
		Shape.prototype.toString = function () {
			...
			result += " X: " + this._x + " Y: " + this._y + " Color: " + this._color;
			return result;	
		}
		return Shape;
	}());
	...
	var Rectangle = (function() {
		...
		Rectangle.prototype.toString = function () {
			...
			result += " Widht: " + this._width + " Height: " + this._height;
			return result;
		}
		return Rectangle;
	}());
	...
	var Triangle = ( function() {
		...
		Triangle.prototype.toString = function() {
			var result = Shape.prototype.toString.call(this);
			result += " X1: " + this.getX1()  +" Y1: " + this.getY1();
			result += " X2: " + this.getX2()  +" Y2: " + this.getY2();
			return result;		
		};
		return Triangle;
	...
	var Segment = (function() {
		...
		Segment.prototype.toString = function(first_argument) {
			var result = Shape.prototype.toString.call(this);
